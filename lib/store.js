...
function addChild(family, name, grade) {
  ...
  family.children[id] = {
    ...
    adventure: { chapterId: 'first-starlight', chapterDay: 1, completedDays: [], chapterCompletedAt: null, chapterCompletions: [], lastPlayedOn: null, currentNodeId: null, visited: [], discoveries: [], signatureEvents: [], randomEvents: [], lastResult: null }
  };
  save();
