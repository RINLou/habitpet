...
'use strict';
const { speciesById, skillById, makeBoss, typeMult, ELEMENT_NAMES } = require('./species');
const { addXP, stageOf, dateKey } = require('./engine');
...
module.exports = { startBattle, playerMove, getBattle, canBattleToday, noteBattle, publicBattle };
